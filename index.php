...
<div class="container mt-4">
  ...
  <section id="about">
    ...
    <img src="image/Screenshot 2025-05-31 205937.png" class="img-fluid" alt="Kantin">
    <video controls class="mt-2 w-100">
      <source src="kantin.mp4" type="video/mp4">
    </video>
    <img src="image/Screenshot 2025-05-31 205937.png" alt="Logo Kantin" class="mt-3" style="width:100px;">
  </section>
  ...
  while ($row = $kantins->fetch_assoc()) {
    // Ganti 'nasigoreng.png' dengan nama gambar statis yang kamu mau, atau buat mapping jika banyak menu
    $gambar = 'nasigoreng.png';  // contoh gambar default

    echo "<div class='card mt-3'>
      <div class='row g-0'>
        <div class='col-md-4'>
          <img src='image/$gambar' class='img-fluid rounded-start' alt='Gambar Menu'>
        </div>
        <div class='col-md-8'>
          <div class='card-body'>
            <h5 class='card-title'>" . htmlspecialchars($row['kantin']) . "</h5>
            <p class='card-text'>Menu: " . htmlspecialchars($row['menu']) . " - Rp" . number_format($row['harga'],0,',','.') . "</p>
            <p class='card-text'>Stok: " . intval($row['stok']) . "</p>
          </div>
        </div>
      </div>
    </div>";
...
<footer class="bg-dark text-white text-center py-3 mt-5">
  &copy; <?php echo date("Y"); ?> Dibuat oleh Argan. 
</footer>
